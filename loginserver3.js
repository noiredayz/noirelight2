...
const permList = "channel_editor channel:manage:broadcast user:read:blocked_users";
...
ptl("Предупреждение! This login server is made to get an oauth code to manage the channel of the operator!");
...
function parseAuth(inmsg){
	...
	retval += `
	<br>
	This code can be used by the bot to set things of the operators own channel such as title, game etc.<br>
	Save the code in the db as twitch-management-code
	</body></html>`;
	return retval;
...
function loginpage(){
	return `
	<html>
	<head><title>noirelight2 implicit code generator for operator channel management</title></head>
	<body>
	Click this link to get redirected to twitch authentication.<br>
	You need to be logged in with the operators account.<br>
